...
to **predict the likelihood of thyroid cancer recurrence** based on patient data.
""")
...
View model performance under **Dashboard**.
""")
...
def user_input_features():
    ...
    pathology = st.selectbox('Pathology', ['Follicular', 'Hurthel cell', 'Micropapillary', 'Papillary'])
